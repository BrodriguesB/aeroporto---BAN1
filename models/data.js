...
const data = [
    ...
    VALUES ('19337264749','ALESSANDRA AZEVEDO DA COSTA',true,'economica',NULL,984575412,001,01),
        ...
        ('29513624803','ELIVELTON DOS SANTOS PIRES','economica',NULL,99292376789,005,07),
        ('38613219802','KIMAYR RODRIGUES DOS SANTOS','vip',NULL,99447338328,005,08),
        ('39697049874','EDJANETE ANNE FRANCYS NAJA SILVA','economica',NULL,9942200418,005,09);
    ...
    VALUES 	
        ...
        (006,'Curitiba/Nova Yorke','2017/12/31','12:00',123),
        (007,'Nova York/Lisboa','2017/11/05','13:10',234),
        (008,'Brasilia/Salvador','2018/03/21','14:15',201),
        (009,'Rio/Janeiro','2018/01/11','16:05',318),
        (010,'Sao Paulo/Curitiba','2018/02/03','19:30',987),
        (011,'Porto Alegre/Florianopolis','2018/02/03','18:25',876),
        (012,'Salvador/Fortaleza','2017/12/28','06:45',765),
        (013,'Rio de Janeiro/Paris','2017/12/25','07:00',654),
        (014,'Sao paulo/Sidney','2017/12/24','08:10',543),
        (015,'Sao Paulo/Rio de Janeiro','2017/12/29','10:20',432),
        (016,'Belo Horizonte/Manaus','2017/12/27','00:00',321),
        (666,'Berlin/Madri','2666/06/06','03:00',219);
